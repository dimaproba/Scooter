(() => {
    ...
    function initSliders() {
        if (document.querySelector(".image-column__slider")) new swiper_core_Swiper(".image-column__slider", {
            ...
            pagination: {
                ...
                renderCustom: function(swiper, current) {
                    const formattedCurrentSlide = current.toString().padStart(2, "0");
                    return formattedCurrentSlide;
                }
            },
            navigation: {
                prevEl: ".image-column__button-prev",
                nextEl: ".image-column__button-next"
            },
            on: {}
        });
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const menuItem = document.querySelector(".menu__item:first-child");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        menuItem.addEventListener("click", (function() {
            ...
            if (isActive) menuItem.classList.remove("active"); else menuItem.classList.add("active");
        }));
    }));
    window["FLS"] = true;
    isWebp();
